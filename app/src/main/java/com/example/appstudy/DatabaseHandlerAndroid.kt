...
class DatabaseHandlerAndroid(context : Context): SQLiteOpenHelper(
    context,
    DATABASE_NAME,
    null,
    DATABASE_VERSION)
{
    ...
    companion object{
        ...
        private const val DATABASE_NAME = "StudyAppAndroid"
    }
    ...
    @SuppressLint("Range")
    fun getStudyNotes(): ArrayList<StudyNoteAndroid>{
        val notes: ArrayList<StudyNoteAndroid> = ArrayList()
        val tableName = "Study"
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                val singleNote = StudyNoteAndroid(id, title, details )
    ...
    fun updateNote(note: StudyNoteAndroid): Int{
    ...
    fun deleteNote(note: StudyNoteAndroid): Int{
